...
var jsonSafeStringify = __webpack_require__(22)
...
var _sanitizeFilename = __webpack_require__(54);

var _sanitizeFilename2 = _interopRequireDefault(_sanitizeFilename);

var _toughCookieFilestore = __webpack_require__(55);
...
var HTTP = function () {
	function HTTP(context) {
		...
		context = (0, _sanitizeFilename2.default)(context);
		var cookieFile = './cookies/' + context + '.json';
		_helpers2.default.createFileIfNotExists(cookieFile, function () {
			_this.cookieFile = cookieFile;
		});
	}
	...
	_createClass(HTTP, [{
		...
		key: 'attachDefaults',
		value: function attachDefaults(options) {
			return Object.assign(options, {
				jar: _Request2.default.jar(new _toughCookieFilestore2.default(this.cookieFile)),
				gzip: true
			});
		}
	}, {
...
var tough = __webpack_require__(21)
...
var _mkdirp = __webpack_require__(51);
...
var _nodeGeocoder = __webpack_require__(53);
...
var Helpers = function () {
	function Helpers() {
		...
		this.geocoder = (0, _nodeGeocoder2.default)({
			provider: 'google'
		});
	}

	_createClass(Helpers, [{
		key: 'createFileIfNotExists',
		value: function createFileIfNotExists(file, cb) {
			if (!_fs2.default.existsSync(file)) {
				_mkdirp2.default.sync(_path2.default.dirname(file));
				_fs2.default.writeFileSync(file, '', { flags: 'a+' });
			}
			cb();
		}
	}, {
		...
		key: 'rgeocode',
		value: function rgeocode(lat, lon) {
...
var _foodradar = __webpack_require__(18);

var _foodradar2 = _interopRequireDefault(_foodradar);
...
var radar = new _foodradar2.default({ lat: 48.856614, lon: 2.352222 });
// radar.getRestaurants().then(r => {
// 	fs.writeFile('debug.json', JSON.stringify(r))
// })

radar.getRestaurant(8181, 'deliveroo').then(function (r) {
	console.log(r);
});
...
var _deliveroo = __webpack_require__(19);

var _deliveroo2 = _interopRequireDefault(_deliveroo);

var _foodora = __webpack_require__(56);

var _foodora2 = _interopRequireDefault(_foodora);
...
var FoodRadar = function () {
	function FoodRadar(address) {
		_classCallCheck(this, FoodRadar);

		this.address = address;
	}

	_createClass(FoodRadar, [{
		key: 'updateAddress',
				...
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								if (!((typeof address === 'undefined' ? 'undefined' : _typeof(address)) == 'object' && address.lat && address.lon)) {
									_context.next = 6;
									break;
								}
							...
							case 6:
								...
								_context.prev = 7;
								_context.next = 10;
								return _helpers2.default.geocode(address);
		...
		key: 'getRestaurantsDeliveroo',
		value: function getRestaurantsDeliveroo() {
			var _this = this;
			...
			return new _bluebird2.default(function (resolve, reject) {
				var deliRestaurants = [];
				_deliveroo2.default.restaurants(_this.lat, _this.lon).then(function (r) {
					if (r.restaurants) deliRestaurants = r.restaurants.map(function (v) {
						return {
							app: 'deliveroo',
							id: v.id,
							name: v.name,
		...
		key: 'getRestaurantsFoodora',
		value: function getRestaurantsFoodora() {
			var _this2 = this;
			...
			return new _bluebird2.default(function (resolve, reject) {
				var foodRestaurants = [];
				_foodora2.default.restaurants(_this2.lat, _this2.lon).then(function (r) {
					if (r.data.items) foodRestaurants = r.data.items.map(function (v) {
						return {
							app: 'foodora',
							id: v.id,
							name: v.name,
						...
						switch (_context2.prev = _context2.next) {
							...
							case 3:
								return _context2.abrupt('return', new _bluebird2.default(function (resolve, reject) {
									...
									var promises = [];
									promises[0] = _this3.getRestaurantsDeliveroo(raw);
									promises[1] = _this3.getRestaurantsFoodora(raw);

									_bluebird2.default.all(promises).then(function (restaurants) {
		...
		value: function getRestaurant(id) {
			...
			var app = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
			...
			return new _bluebird2.default(function (resolve, reject) {
				...
				switch (app) {
					case 'foodora':
						promises[0] = _foodora2.default.restaurant(id);
						break;
					case 'deliveroo':
						promises[1] = _deliveroo2.default.restaurant(id, _this4.lat, _this4.lon);
						break;
					default:
						promises[0] = _foodora2.default.restaurant(id);
						promises[1] = _deliveroo2.default.restaurant(id, _this4.lat, _this4.lon);
				...
				_bluebird2.default.all(promises).then(function (results) {
					results = [].concat.apply([], results).filter(function (v) {
						if (v) if (v.id) return true;
						return false;
					});
					resolve(results);
				});
...
var userAgent = "Deliveroo-OrderApp/2.18.0 (iPhone9,3; iOS10.3.2; Release; en_EN; 8365)",
    _api = 'https://deliveroo.co.uk/orderapp/v1/';

var Deliveroo = function () {
	function Deliveroo() {
		_classCallCheck(this, Deliveroo);

		this.req = new _http2.default('Deliveroo');
	}

	_createClass(Deliveroo, [{
		key: 'api',
		...
		key: 'restaurants',
		value: function restaurants() {
			var lat = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 48.828459;
			var lon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2.356061;
		...
		key: 'restaurant',
		value: function restaurant(id) {
			var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 48.828459;
			var lon = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2.356061;
		...
		value: function headers() {
			...
			if (params) headers = Object.assign(headers, params);
...
request.Request = __webpack_require__(23)
...
var http = __webpack_require__(24)
  ...
  , zlib = __webpack_require__(28)
  , hawk = __webpack_require__(29)
  , aws2 = __webpack_require__(30)
  , aws4 = __webpack_require__(31)
  , httpSignature = __webpack_require__(32)
  , mime = __webpack_require__(33)
  , stringstream = __webpack_require__(34)
  , caseless = __webpack_require__(4)
  , ForeverAgent = __webpack_require__(35)
  , FormData = __webpack_require__(36)
  , extend = __webpack_require__(2)
  , isstream = __webpack_require__(11)
  , isTypedArray = __webpack_require__(37).strict
  , helpers = __webpack_require__(3)
  , cookies = __webpack_require__(9)
  , getProxyFromURI = __webpack_require__(38)
  , Querystring = __webpack_require__(39).Querystring
  , Har = __webpack_require__(40).Har
  , Auth = __webpack_require__(42).Auth
...
module.exports = require("tough-cookie-filestore");
...
var userAgent = "foodora/8320",
    _api = 'https://api.foodora.fr/api/v5/';

var Foodora = function () {
	function Foodora() {
		_classCallCheck(this, Foodora);

		this.req = new _http2.default('Foodora');
	}

	_createClass(Foodora, [{
		key: 'api',
		value: function api(path) {
			return '' + _api + path;
		}
